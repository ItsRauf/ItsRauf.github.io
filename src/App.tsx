        ...
        <div className="flex flex-col items-center justify-center col-start-4 col-end-10">
          <div className="flex flex-col justify-items-center">
            <div className="flex flex-row items-start pb-2">
              <p className="font-sans text-2xl font-bold leading-7 text-left text-purple-400">
                Hello, I'm Rauf!
              </p>
            </div>
            ...
            <div className="flex flex-row-reverse items-end pt-2">
              <p className="font-sans text-lg font-semibold leading-6 text-right text-purple-400">
            ...
            <div className="flex items-center justify-center pt-12 flew-row">
              <div className="flex flex-row items-center w-56 justify-evenly">
                ...
                <a href="https://instagram.com/ItsRauf_">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    version="1.1"
                ...
                <a href="https://www.youtube.com/channel/UCFqd_VkM_ydgDjuvRxAMh3Q">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    version="1.1"
                ...
                <a href="https://open.spotify.com/artist/6Ko05GhMLMalD5Abnk2wR9">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    version="1.1"
                ...
                <a href="https://soundcloud.com/itsrauf">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    version="1.1"
                ...
                <a href="https://github.com/ItsRauf">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    version="1.1"
